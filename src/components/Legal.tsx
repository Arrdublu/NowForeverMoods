    ...
    <Container>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-brand-line border border-brand-line shadow-sm mb-20">
        <div className="bg-white p-12 flex flex-col items-center text-center space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-brand-muted hover:text-brand-accent transition-colors cursor-pointer">admin@nowforevermoods.com</p>
        ...
        <div className="bg-white p-12 flex flex-col items-center text-center space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-brand-muted">+1 (876) 283-3276</p>
      ...
      <div className="space-y-16">
        ...
        <div className="grid gap-12">
          ...
          />
          <FAQItem 
            q="Do you provide more cinematic packages?" 
          ...
          />
          <FAQItem 
            q="Can I book a last-minute session?" 
            a="Availability for immediate sessions depends on logistical telemetry. Please contact our Caribbean Bureau directly if you require assistance with an expedited booking requested within 7 days of the desired date." 
          />
          <FAQItem 
            q="What are your protocols for adverse weather conditions in Jamaica?" 
            a="Our primary bureau in Jamaica maintains localized weather telemetry. If adverse conditions compromise the creative output of an outdoor session, we will coordinate a rescheduling protocol within the same contractual period to ensure your editorial vision is fully realized." 
          />
          <FAQItem 
            q="Is there a limitation to the number of participants?" 
            a="Signature Sessions are designed for intimate creative focus. Additional participants can be vetted by the production team. Please confirm the total party count via your lead coordinator before finalizing your collection." 
          />
          <FAQItem 
            q="How is our personal data secured across the collective?" 
            a="We adhere to a strict partition policy: all beauty-related information is governed by Ioka, while production and technical data reside within Arrdublu’s secure infrastructure. Both teams adhere to high-level encryption standards compliant with FIPA and international privacy conventions." 
          />
          <FAQItem 
            q="Are images edited or retouched?" 
            a="Yes. Every delivered image undergoes our signature technical retouching process—combining Arrdublu’s cinematic color grading with Ioka’s precise beauty enhancement standards—to deliver a finished, high-fidelity archive." 
          />
        </div>
      </div>
